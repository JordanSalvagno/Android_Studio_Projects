...
public class BaseActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
        KeyValues keyValues = new KeyValues();
        String curUser = keyValues.getCurrentUser(getApplicationContext());

        if (id == R.id.nav_profile) {
            //load logged in users profile
            Intent intent = new Intent(this, UserProfileActivity.class);
            intent.putExtra(UserProfileActivity.USER_ID_EXTRA, curUser);
            ...
            Intent intent = new Intent(this, UserProfileActivity.class);
            intent.putExtra(UserProfileActivity.FRAGMENT_TO_LOAD_EXTRA, UserProfileActivity.UserFragmentToLaunch.EDIT);
            intent.putExtra(UserProfileActivity.USER_ID_EXTRA, curUser);
            startActivity(intent);
        }

...
public class InterestedUserAdapter extends ArrayAdapter<User> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null) {
            ...
            viewHolder.userImage = (ImageView) convertView.findViewById(R.id.InterestedUserListItemUserImg);
        ...
        viewHolder.userImage.setImageResource(User.userIdToDrawable(1));
        viewHolder.userName.setText(interestedUser.getUname());
        Random random = new Random();
        viewHolder.userRating.setNumStars(random.nextInt(5) + 1);

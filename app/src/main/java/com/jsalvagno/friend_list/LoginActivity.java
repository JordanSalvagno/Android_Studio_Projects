...
//    public static final String CURRENT_USER_ID = "com.jsalvagno.friend_list.Current User";
    ...
    private void userLogin(String email, String password) {
        String url = "http://192.241.232.97:3000/auth/sign_in";
        Log.d("Login url", url + " " + email + ", " + password);
        ...
        Log.d("jsonParams", loginObject.toString());
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, loginObject,
